...
<html lang="en">
    ...
    <head>
        ...
        <title>Events | Vendor Category </title>
        <!-- Bootstrap -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                        <div class="page-caption">
                            <h1 class="page-title">Vendor Category</h1>
                        </div>
                    </div>
                    <!-- /.page caption -->
                </div>
        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    ...
                    $q = mysqli_query($connection, 'select * from vendor_cat_tbl');
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="vendor-thumbnail">
                                ...
                                <div class="vendor-content">
                                    <!-- Vendor Content -->
                                    <h2 class="vendor-title"><a href="ven-set.php?eid=<?php echo "{$row['ven_cat_id']}"; ?>" class="title"><?php echo "{$row['ven_cat_name']}"; ?></a></h2>
                                </div>
                                <!-- /.Vendor Content -->
                                <div class="vendor-meta">
                                    <div class="vendor-meta-item vendor-meta-item-bordered">
                                        <span class="vendor-price">
                                            <a href="ven-set.php?eid=<?php echo "{$row['ven_cat_id']}"; ?>">View Details</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
